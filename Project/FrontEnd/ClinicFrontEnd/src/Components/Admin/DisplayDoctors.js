...
class DisplayDoctors extends React.Component{
    ...
    /**
     * fetch data, parse data and set state of doctors
     */
    componentDidMount() {
        ...
        fetch(api_get)
            ...
            .then(data => {
                    ...
                    for (var i = 0; i < json.length; i++) {
                        ...
                        //var final = "Name:-"+fn+" Last Name:-"+ln+" Qualification:-"+qua+" Specilization:-"+spe+"
                        // Time"+time+" Fees:-"+fees+" Experience:-"+exp; var final = "\n<b>Name</b>"+fn+"\n"+exp+"\n";
                        ...
                        //var final = ' <ul class="list-group list-group-flush"> <li class="list-group-item">Cras justo
                        // odio</li><li class="list-group-item">Dapibus ac facilisis in</li><li
