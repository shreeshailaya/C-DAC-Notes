...
class PatientProfile extends React.Component {
    ...
    /**
     * fetch data and set state of data
     */
    componentDidMount() {
            ...
            <div>
                ...
                <div className="contact-wrapper">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <img
                                    ...
                                    className="img-responsive" height="580" width="350"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="contact-form" className="form-horizontal" role="form">
                        ...
                        <div className="form-outline mb-4">
                            <label className="form-label" htmlFor="form3Example9">Contact No</label>
                            <input type="number" className="form-control" id="name" value={ this.state.contact_no }
                                   name="name" onChange={ this.contact_no } required/>
                        </div>

                        <div className="form-outline mb-4">
                            <label className="form-label" htmlFor="form3Example9">Address</label>
                            <input type="text" className="form-control" id="name" value={ this.state.address } name="name"
